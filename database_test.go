...
func setupTestDB(t *testing.T) (*DBManager, string, func()) {
	...
	manager, err := OpenDB(dbPath, false)
	if err != nil {
...
// createTestZoneFile creates a test zone file
...
func TestProcessFile(t *testing.T) {
	...
	processed, updated, err := manager.ProcessFile(filePath)
	if err != nil {
...
func TestProcessDirectory(t *testing.T) {
	...
	processed, _, err := manager.ProcessDirectory(tempDir)
	if err != nil {
...
func TestUpdateIPRangeCountry(t *testing.T) {
	...
	// Add an IP range
	success, err := manager.UpdateIPRangeCountry(ipRange, start, end, "FR")
	if err != nil {
...
func TestVerifyIndexes(t *testing.T) {
	...
	count, err := manager.VerifyIndexes()
	if err != nil {
